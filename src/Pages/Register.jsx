...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/admin'); // Redirect ke admin dashboard setelah register
    } catch (err) {
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                ...
                padding: '0.625rem 1rem',
                borderRadius: '10px',
                background: loading || !name || !email || !password ? '#334155' : '#6366f1',
                color: 'white',
                border: 'none',
          ...
          <div style={{ marginTop: '1.5rem', textAlign: 'center' }}>
            <p style={{ color: '#94a3b8', fontSize: '0.875rem' }}>
              Sudah punya akun? <Link to="/login" style={{ color: '#818cf8', textDecoration: 'none' }}>Masuk di sini</Link>
            </p>
          </div>
        </div>
      </div>
